"""
This entire code creates the orders dictionary and includes relevant information
like address, quantity, and product ID, 
and commits it all to the current session.
"""
